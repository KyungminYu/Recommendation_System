<%@page import="dbHandling.DBHandler, java.util.ArrayList"%>
...
ArrayList<String> friendList = dbHandler.getFriends(id);
%>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <% 
	                    if(friendList.size()>0)
		                    out.println("<li><a href='getFriendsMovie.jsp?Friend="+friendList.get(0)+"' target=framecontainer>내 친구목록</a></li>");
	                    else
	                    	out.println("<li><a href='getFriendsMovie.jsp?Friend=' target=framecontainer>내 친구목록</a></li>");
                    %>
